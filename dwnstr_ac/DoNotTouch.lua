--Decrypt And Crack By NNCT#6018
...
function ialwSodwmajs(a, ...)
  ...
  RegisterNetEvent("DawN:Frandkdsa")
  AddEventHandler("DawN:Frandkdsa", function(a)
    a = a
  ...
  Citizen.CreateThread(function()
    function Citizen.InvokeNative(...)
      ...
      if string.find({
        ...
        ialwSodwmajs("pdajwndwicamsmew", "Inject menu detected in: " .. va)
        while true do
          Citizen.Wait(500)
          RestartGame()
