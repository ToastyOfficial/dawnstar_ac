RegisterCommand("dwnstrAC", function(source, ai, aj)
	if source == 0 then
		print("")
		...
		if ai[1] == "install" then
			...
			print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^1Resources ^0("..af[1].."/"..af[2].." for ^1"..ae.." ^1completed). ^0"..af[3].." ^1skipped.^0")
			print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^8Restart your server!!!^0")
			af = nil
		elseif ai[1] == "help" then
			print("^1**^5Dawnstar Anti-Cheat Installation^1**")
			print("")
			print("^1[*]^5Usage: ^0\"dwnstrAC install\" -- for __resource.lua files")
			print("^1[*]^5Usage: ^0\"dwnstrAC install fx\" -- for fxmanifest.lua files")
			print("----------------------")
			print("^1**^5DwnstrAC Uninstall^1**")
			print("")
			print("^1[*]^5Usage: ^0\"dwnstrAC uninstall\" -- for __resource.lua files ")
      print("----------------------")
      print("^1[*]^5Usage: ^0\"dwnstrAC uninstall fx\" -- for fxmanifest.lua files")
      print("----------------------")
      print("")
      print("^1**^5Dawnstar Anti-Cheat Banreload^1**")
      print("^1[*]^5Usage: ^0\"dawnreload")
			print("----------------------")
			print("^1[*]^8Help: ^0dwnstrAC help^0")
		end;
		if ai[1] == "uninstall" then
			if not af then
				...
				print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^1Resources ^0("..af[1].."/"..af[2].." for ^1"..ae.." completed). ^0"..af[3].." ^1skipped.^0")
				print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^8Restart your server!!!^0")
				af = nil
		end
	else
		...
		if not ao then
			...
			if av then
				...
				if ap then
					...
					ap:close()
					af[1] = af[1] + 1;
					print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^2Installation ^0"..ar.." ^2completed.^0")
				else
					print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^8Installation failed on ^0"..ar.."^8.^0")
				end;
				af[2] = af[2] + 1
			else
				af[3] = af[3] + 1
			...
			if au then
				...
				if ap then
					...
					print("^8Failed uninstalling Dawnstar Anti-Cheat from "..ar..".^0")
					print("^8Make sure you are using the right variable!!!.^0")
					au, av = false, false
				end
			end;
			if au or av then
				print("^"..math.random(1, 9).."Dawnstar Anti-Cheat^0: ^2Uninstalled from ^0"..ar.." ^2successfully.^0")
				af[1] = af[1] + 1
			end
		end
	else
